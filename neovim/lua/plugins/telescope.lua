...
u.command("LiveGrep", "Telescope live_grep")
u.command("Ag", "Telescope grep_string use_regex=true")
...
u.map("n", "<Leader>fg", "<cmd>LiveGrep<CR>")
u.map("n", "<Leader>fa", "<cmd>Ag<CR>")
...
u.command("LspDocSym", "Telescope lsp_document_symbols")
